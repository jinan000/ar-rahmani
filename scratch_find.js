...
async function findSpecificProduct(title) {
  const query = `
  ...
  try {
    ...
    console.log(`Results for ${title}:`, JSON.stringify(json, null, 2));
  } catch(e) {
    console.error(e);
  }
}

findSpecificProduct("Hamood");
findSpecificProduct("Paradise");
findSpecificProduct("Sabr");
